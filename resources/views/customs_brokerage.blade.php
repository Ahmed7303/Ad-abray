...
@section('content')
    <section id="page-title" class="page-title bg-overlay bg-parallax">
        <div class="bg-img"><img src="images/page-titles/Customs.jpg" alt="background"></div>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('strings.customs_brokerage') }}
                            </li>
                        </ol>
                    </nav>
                    <h1 class="pagetitle__heading">{{ __('strings.customs_brokerage') }}</h1>
                </div><!-- /.col-lg-12 -->
            </div><!-- /.row -->
        </div><!-- /.container -->
    </section><!-- /.page-title -->
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="text__block mb-40">
                                    <h5 class="text__block-title">{{ __('strings.custom_brokerage_p0') }}</h5>
                                    <p class="text__block-desc">{{ __('strings.custom_brokerage_p1') }}</p>
                                    <p class="text__block-desc">{{ __('strings.custom_brokerage_p2') }}</p>

                                </div><!-- /.text-block -->
                                <div class="row">
                                    <div class="col-sm-12 col-md-7 col-lg-7">
                                        <div class="text__block ">
                                            <p class="text__block-desc"><b>{{ __('strings.custom_brokerage_p3') }}</b>
                                            </p>
                                            <p class="text__block-desc">{{ __('strings.custom_brokerage_p4') }}</p>
                                        </div><!-- /.text-block -->
                                    </div><!-- /.col-lg-6 -->
                                    <div class="col-sm-12 col-md-5 col-lg-5">
                                        <div class="row ">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                <img src="images/Types of Servics/Customs.jpg" alt="chart"
                                                    class="img-fluid mt-50 mb-30">
                                            </div><!-- /.col-lg-12 -->
                                        </div><!-- /.row -->
                                    </div><!-- /.col-lg-6 -->
                                </div>
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="text__block">
                                            ...
                                            <p class="text__block-desc">{{ __('strings.why_us_defcus') }}</p>
                                        </div><!-- /.text-block -->
                                    </div><!-- /.col-lg-12 -->
                                </div><!-- /.row -->
                ...
                <div class="col-sm-12 col-md-12 col-lg-8">
                    <div class="contact-panel">
                        ...
                        <ul class="contact__list list-unstyled">
                            <li><b>{{ __('strings.tel1_head') }}</b>{{ __('strings.team_name21_tel') }}</li>
                            <li><b>{{ __('strings.mail_head') }}</b>{{ __('strings.team_name21_mail') }}</li>
                            <li><b>{{ __('strings.address_head') }}</b>{{ __('strings.team_name21_address') }}</li>
