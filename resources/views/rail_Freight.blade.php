...
@section('content')
    ...
    <section id="page-title" class="page-title bg-overlay bg-parallax">
        <div class="bg-img"><img src="images/rail/1.jpg" alt="background"></div>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('strings.rail_freight') }}</li>
                        </ol>
                    </nav>
                    <h1 class="pagetitle__heading">{{ __('strings.rail_freight') }}</h1>
                </div><!-- /.col-lg-12 -->
            </div><!-- /.row -->
        </div><!-- /.container -->
    </section><!-- /.page-title -->
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="text__block mb-40">
                                    <h5 class="text__block-title">{{ __('strings.rail_p0') }}</h5>
                                    <p class="text__block-desc">{{ __('strings.rail_p1') }}</p>
                                    <p class="text__block-desc">{{ __('strings.rail_p2') }}</p>
                                </div><!-- /.text-block -->
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <h5>{{ __('strings.rail_p3') }}</h5>
                                                    ...
                                                    <div class="accordion__item-body">
                                                        <div class="row">
                                                            <div class="col-sm-12 col-md-7 col-lg-7">
                                                                <div class="text__block  mb-40">
                                                                    <p class="text__block-desc">
                                                                        {{ __('strings.rail_p4_1') }}</p>
                                                                    <p class="text__block-desc">• 136 m³</p>
                                                                    <p class="text__block-desc">• 138 m³</p>
                                                                    <p class="text__block-desc">• 158 m³</p>
                                                                    <p class="text__block-desc">• 168 m³</p>
                                                                    <p class="text__block-desc">
                                                                        {{ __('strings.rail_p4_2') }}</p>
                                                            ...
                                                            <div class="col-sm-12 col-md-5 col-lg-5">
                                                                <div class="row">
                                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                                        <img src="images/Types of Servics/Крытый without bg.png"
                                                    ...
                                                    <div class="accordion__item-body">
                                                        <div class="row">
                                                            <div class="col-sm-12 col-md-7 col-lg-7">
                                                                <div class="text__block  mb-40">
                                                                    <p class="text__block-desc">
                                                                        {{ __('strings.rail_p5_1') }}</p>
                                                                    <br>
                                                                    <p class="text__block-desc">
                                                                        {{ __('strings.rail_p5_2') }}</p>
                                                                    <p class="text__block-desc">
                                                                        {{ __('strings.rail_p5_3') }}</p>
                                                            ...
                                                            <div class="col-sm-12 col-md-5 col-lg-5">
                                                                <div class="row">
                                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                                        <img src="images/Types of Servics/Полувагон-without bg.png"
                                                                            alt="chart" class="img-fluid mt-50 mb-30">
                                                                    </div><!-- /.col-lg-12 -->
                                                                </div><!-- /.row -->
                                                            </div><!-- /.col-lg-6 -->
                                                    ...
                                                    <div class="accordion__item-body">
                                                        <div class="row">
                                                            <div class="col-sm-12 col-md-7 col-lg-7">
                                                                <div class="text__block  mb-40">
                                                                    <p class="text__block-desc">
                                                                        {{ __('strings.rail_p6_1') }}</p>
                                                                    <br>
                                                                    <p class="text__block-desc">
                                                                        {{ __('strings.rail_p6_2') }}</p>
                                                                    <p class="text__block-desc">
                                                                        {{ __('strings.rail_p6_3') }}</p>
                                                                    <p class="text__block-desc">
                                                                        {{ __('strings.rail_p6_4') }}</p>
                                                                </div><!-- /.text-block -->
                                                            </div><!-- /.col-lg-6 -->
                                                            <div class="col-sm-12 col-md-5 col-lg-5">
                                                                <div class="row">
                                                    ...
                                                    <div class="accordion__item-body">
                                                        <div class="row">
                                                            <div class="col-sm-12 col-md-7 col-lg-7">
                                                                <div class="text__block  mb-40">
                                                                    <p class="text__block-desc">
                                                                        <b>{{ __('strings.rail_p7_1') }}</b>{{ __('strings.rail_p7_2') }}
                                                                    </p>
                                                                    <br>
                                                                    <p class="text__block-desc">
                                                                        {{ __('strings.rail_p7_3') }}<b>{{ __('strings.rail_p7_4') }}</b>{{ __('strings.rail_p7_5') }}
                                                                    </p>
                                                                </div><!-- /.text-block -->
                                                            </div><!-- /.col-lg-6 -->
                                                            <div class="col-sm-12 col-md-5 col-lg-5">
                                        ...
                                        <div class="projects-carousel-2 carousel owl-carousel carousel-dots" data-slide="3"
                                            ...
                                            <div class="project-item">
                                                <div class="project__img">
                                                    <img src="images/Types of Servics/Крытый without bg.png"
                                                        alt="project img" class="img-fluid">
                                                </div><!-- /.project-img -->
                                                <div class="project__content">
                                                    <div class="project__cat">
                                                    </div><!-- /.project-cat -->
                                                    <h4 class="project__title">{{ __('strings.rail_p4') }}</h4>
                                                </div><!-- /.project-content -->
                                            </div><!-- /.project-item -->
                                            <div class="project-item">
                                                <div class="project__img">
                                                ...
                                                <div class="project__content">
                                                    ...
                                                    <h4 class="project__title">{{ __('strings.rail_p5') }}</h4>
                                                </div><!-- /.project-content -->
                                            </div><!-- /.project-item -->
                                            <div class="project-item">
                                                <div class="project__img">
                                                    <img src="images/Types of Servics/cisterna.jpg" alt="project img"
                                                        class="img-fluid">
                                                </div><!-- /.project-img -->
                                                <div class="project__content">
                                                    <div class="project__cat">
                                                    </div><!-- /.project-cat -->
                                                    <h4 class="project__title">{{ __('strings.rail_p6') }}</h4>
                                                </div><!-- /.project-content -->
                                            </div><!-- /.project-item -->
                                            <div class="project-item">
                                                <div class="project__img">
                                                ...
                                                <div class="project__content">
                                                    ...
                                                    <h4 class="project__title">{{ __('strings.rail_p7') }}</h4>
                                                </div><!-- /.project-content -->
                                            </div><!-- /.project-item -->
                                        </div><!-- /.carousel -->
                                    </div><!-- /.col-lg-12 -->
                                ...
                                <div class="row mt-50">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="text__block">
                                            ...
                                            <p class="text__block-desc">{{ __('strings.why_us_defra') }}</p>
                                        </div><!-- /.text-block -->
                                    </div><!-- /.col-lg-12 -->
                                </div><!-- /.row -->
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-4 col-lg-4">
                                            <div class="fancybox-item">
                                                ...
                                                <div class="fancybox__content">
                                                    <h4 class="fancybox__title">{{ __('strings.affordable_pricing') }}
                                                    </h4>
                                                    <p class="fancybox__desc">{{ __('strings.affordable_pricing_def') }}
                                                    </p>
                                        ...
                                        <div class="col-sm-12 col-md-4 col-lg-4">
                                            <div class="fancybox-item">
                                                ...
                                                <div class="fancybox__content">
                                                    <h4 class="fancybox__title">{{ __('strings.real_time_tracking') }}
                                                    </h4>
                                                    <p class="fancybox__desc">{{ __('strings.real_time_tracking_def') }}
                                                    </p>
                                                </div><!-- /.fancybox-content -->
                                            </div>
                                        </div><!-- /.col-lg-4 -->
                                        <div class="col-sm-12 col-md-4 col-lg-4">
                                            <div class="fancybox-item">
                                                ...
                                                <div class="fancybox__content">
                                                    <h4 class="fancybox__title">{{ __('strings.warehouse_storage') }}
                                                    </h4>
                                                    <p class="fancybox__desc">{{ __('strings.warehouse_storage_def') }}
                                                    </p>
                                                </div><!-- /.fancybox-content -->
                                            </div>
                                        </div><!-- /.col-lg-4 -->
